...
*/}}
{{- define "component-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "component-operator.resourceName" -}}
{{- $fullname := include "component-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
{{- else }}
{{- include "component-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
